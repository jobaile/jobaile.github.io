...
<div id="form-slash" class="container-fluid">
<h3 id="register-now">Subscribe today</h3>
...
<select v-model="input.country" name="country" class="styled-select black">
...
<div class="col-12 justify-content-center form-inline button">
